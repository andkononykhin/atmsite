  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      ngtemplates: {
        ...
        tasks: ['ngtemplates:app'], // TODO newer + livereload
      },
      jsTest: {
        files: ['test/spec/{,*/}*.js'],
      ...
      livereload: {
        ...
        files: [
          '<%= yeoman.app %>/{,*/}*.html',
          '<%= yeoman.djangoAppTemplates %>/{,*/}*.html',
          '.tmp/styles/{,*/}*.css',
    ...
    jshint: {
      ...
      all: {
        src: [
          ...
          '!<%= yeoman.app %>/scripts/templateCache.js',
      ...
      dist: {
        ...
        files: [{
          ...
          src: [
            ...
            '<%= yeoman.dist %>/{,*/}*',
            '!<%= yeoman.dist %>/.git{,*/}*',
            '<%= yeoman.djangoAppTemplates %>/*.min.html',
          ]
        }]
      },
      server: '.tmp'
    ...
    useminPrepare: {
      html: '<%= yeoman.djangoAppTemplates %>/index.html',
      options: {
        dest: '<%= yeoman.dist %>',
        root: '.',
        flow: {
    ...
    usemin: {
      html: ['<%= yeoman.djangoAppTemplates %>/{,*/}*.min.html'],
    ...
    htmlmin: {
      dist: {
        ...
        files: [{
          expand: true,
          cwd: '<%= yeoman.djangoAppTemplates %>',
          src: ['*.min.html'],
          dest: '<%= yeoman.djangoAppTemplates %>'
        }]
      }
    },
      ...
      dist: {
        files: [{
          ...
          rename: function(dest, src) {
            return dest + '/' + src.replace(/\.html$/, '.min.html');
          }
        }, {
          expand: true,
          cwd: '.tmp/images',
